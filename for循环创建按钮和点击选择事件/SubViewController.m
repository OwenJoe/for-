...
#define Start_X [UIScreen mainScreen].bounds.size.width-90         // 第一个按钮的X坐标
#define Start_Y 84.0f           // 第一个按钮的Y坐标
#define Width_Space 5.0f        // 2个按钮之间的横间距
#define Height_Space 20.0f      // 竖间距
#define Button_Height 62.0f    // 高
...
-(void)initButtonMethod
{
    for (int i = 0 ; i < 6; i++) {
        ...
        aBt.frame = CGRectMake(Start_X- index * (Button_Width + Width_Space), page  * (Button_Height + Height_Space)+Start_Y, Button_Width, Button_Height);
        ...
        aBt.tag = i;
        //文字
        NSMutableArray *arry = [[NSMutableArray alloc]initWithObjects:@"11",@"22",@"33",@"44",@"55",@"66",@"77" ,nil];
